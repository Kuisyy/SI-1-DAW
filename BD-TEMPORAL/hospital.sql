...
num-Asegurado int not null,
cod-Poliza int not null,
cod-Hospital int not null,
cod-Medico int not null,
PRIMARY KEY(num-asegurado,cod-Poliza,cod-Hospital,cod-Medico)
CONSTRAINT cod-Medico foreign key(cod-Medico) references medico (cod-Medico),
CONSTRAINT cod-Hospital foreign key (cod-Hospital) references hospital (cod-Hospital),
CONSTRAINT cod-Poliza foreign key (cod-Poliza) references a1c (cod-Poliza),
CONSTRAINT num-Asegurado foreign key (num-Asegurado) references a1c (num-Asegurado)
);
